...
export interface Profile {
  ...
  profileUser: {
    ...
    divisionUser: string;
    /**
     * Kata pengantar pada halaman utama, misalnya: "Hello, I'm [Nama] dari [Divisi]"
     */
    greetingUser: string;
    /**
     * Pilih status saat ini: Learning (sekolah) atau Working (bekerja)
     */
    currentStatus: 'learning' | 'working';
    /**
     * Deskripsi jika status saat ini adalah Learning (sekolah)
     */
    learningInstitution?: string | null;
    /**
     * Deskripsi jika status saat ini adalah Working (bekerja)
     */
    workingInstitution?: string | null;
  };
  socialMedia: {
    /**
     * Masukkan URL GitHub Anda
     */
    github: string;
    /**
     * Masukkan URL LinkedIn Anda
     */
    linkedin: string;
    /**
     * Masukkan email dalam format mailto:, contoh: mailto:email@example.com
     */
    email: string;
  };
  updatedAt: string;
...
export interface ProfileSelect<T extends boolean = true> {
  profileUser?:
    ...
    | {
        ...
        greetingUser?: T;
        currentStatus?: T;
        learningInstitution?: T;
        workingInstitution?: T;
      };
  socialMedia?:
    | T
    | {
